...
Combining our worker earnings estimates with consumer welfare losses:

\begin{table}[H]
\centering
\caption{Net Welfare Assessment (Annual)}
\label{tab:net_welfare}
\begin{threeparttable}
\begin{tabular}{lrr}
\toprule
Component & Billion RUB & Notes \\
\midrule
\textbf{Losses} & & \\
Consumer welfare loss & 445 & Price increases + DWL \\
\midrule
\textbf{Gains} & & \\
Agricultural worker earnings & 20--40 & 6M workers $\times$ 5\% $\times$ 80k avg wage \\
Agricultural firm profits & 50--100 & RFSD profit increase \\
\midrule
\textbf{Net effect} & $-$305 to $-$375 & Net loss to Russia \\
Per capita & $-$2,100 to $-$2,600 RUB & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item \textit{Notes:} Worker gains assume 6 million agricultural workers, 5\% earnings increase, average wage 80,000 RUB/year. Firm profits from RFSD. Consumer losses from \citet{kuznetsova2019counter}.
\end{tablenotes}
\end{threeparttable}
\end{table}

The embargo generates net welfare losses of 300--375 billion rubles annually. Consumer losses far exceed producer and worker gains, with the burden falling disproportionately on poor households. This is consistent with the standard trade theory prediction that protection generates net welfare losses.
