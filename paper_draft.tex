...
\textbf{Our main finding: trade protection raised agricultural earnings, but through more work, not higher wages.} In our baseline specification with individual fixed effects, agricultural workers experienced earnings gains of 3--5 percent relative to other sectors (the extended 2020--2023 sample shows 8--9 percent, but is confounded by pandemic and war). Crucially, our wage decomposition reveals that these gains came entirely from increased hours worked, not from higher hourly wages. Agricultural workers worked 5 additional hours per month post-embargo, while their hourly wage showed no relative increase.

This finding has important implications: the welfare gains to workers from protection are smaller than raw earnings changes suggest once the disutility of additional work is accounted for. Meanwhile, agricultural employment \textit{declined} 36\% despite these earnings gains, and firm-level evidence shows large agriholdings captured most protection rents as profits.
...
Our main finding is that \textbf{trade protection raised agricultural earnings, but through more work, not higher wages}. In our baseline difference-in-differences specification with individual fixed effects, we estimate that monthly earnings in agriculture increased by 3--5 percent relative to other sectors after 2014. However, our wage decomposition reveals that these gains came entirely from increased hours worked: agricultural workers worked approximately 5 additional hours per month post-embargo, while their hourly wage rate showed no relative increase.

This distinction has important welfare implications. Raw earnings gains overstate worker welfare because they do not account for the disutility of additional labor. If agricultural workers were induced to work more hours to capture the same effective wage rate, the welfare gains from protection are substantially smaller than headline earnings effects suggest.
...
\subsection{Key Finding: Earnings Gains Came from Hours, Not Wages}

\textbf{Our most important finding is that the earnings gains documented above came entirely from increased hours worked, not from higher hourly wages.} Table \ref{tab:decomposition_main} decomposes monthly earnings into hourly wages and hours.

\begin{table}[H]
\centering
\caption{Earnings Decomposition: The Hours Channel}
...
The decomposition reveals a striking pattern:
\begin{itemize}
...
\textbf{Interpretation}: Trade protection increased labor demand in agriculture, but this manifested as \textit{more work at the same hourly rate} rather than \textit{higher wages for the same hours}. This is consistent with elastic labor supply: agricultural workers (or potential entrants from underemployment) supplied additional hours when demand increased, preventing hourly wages from rising.

\textbf{Welfare implications}: This finding substantially changes the welfare interpretation of our results. Raw earnings gains of 3--5\% overstate worker welfare because they do not account for the disutility of additional labor. If agricultural workers were induced to work 5 more hours per month (a 3\% increase) to capture the same effective wage rate, the welfare gains from protection are substantially smaller than headline earnings effects suggest.

We provide additional analysis of this mechanism in Section \ref{sec:hours_pretrends}, including robustness tests and discussion of pre-existing hours differences between sectors.
